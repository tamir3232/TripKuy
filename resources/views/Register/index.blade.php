        ...
        <main class="form-signin">
            <form action="/register" method="post">
                ...
                <div class="form-floating">
                    <p for="floatingInput">Name</p>
                    <input type="text" name="name" class="form-control @error('name')is-invalid @enderror"
                        id="floatingInput" value="{{ old('name') }}">
                </div>
                <div class="form-floating">
                    <p for="floatingInput">Alamat</p>
                    <input type="text" name="alamat" class="form-control" id="floatingPassword"
                        value="{{ old('alamat') }}">
                </div>
                <div class="form-floating">
                    <p for="floatingInput">Email</p>
                    <input type="email" name="email" class="form-control @error('email')is-invalid @enderror"
                        id="floatingInput" value="{{ old('email') }}">
                </div>
                <div class="form-floating">
                    <p for="floatingInput">Username</p>
                    <input type="text" name="username" class="form-control @error('username')is-invalid @enderror"
                        id="floatingInput" value="{{ old('username') }}">
                </div>
